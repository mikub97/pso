...
public class EdgeTest {
    ...
    public void testGetWeight() {
        ...
        assertEquals(expResult, instance.getWeight(), Double.MIN_VALUE);
    }
    ...
    public void testClone() {
        ...
        Edge<String, String> instClone = new Edge<>("edge1", 1.0, vertex1, vertex1);
    ...
    public void TestGetElement() {
        Vertex<String, String> vertex1 = new Vertex<>(1, "Vertex1");
        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex1, vertex1);
        assertEquals("edge1",otherEdge.getElement());
...
//        Vertex<String, String> vertex1 = new Vertex<>(1, "Vertex1");
//        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex1, vertex1);
//        assertEquals(Objects.hash(otherEdge.getElement(),otherEdge.getWeight(),vertex1,vertex1),
//                otherEdge.hashCode());
//
//    }
    ...
    public void TestSetElement() {
        Vertex<String, String> vertex1 = new Vertex<>(1, "Vertex1");
        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex1, vertex1);
        otherEdge.setElement("blabla");
        assertEquals("blabla", otherEdge.getElement());
    }
    ...
    public void TestGetWeight() {
        Vertex<String, String> vertex1 = new Vertex<>(1, "Vertex1");
        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex1, vertex1);
        assertEquals(1.0, otherEdge.getWeight(),Double.MIN_VALUE);
    }
    ...
    public void TestSetWeight() {
        Vertex<String, String> vertex1 = new Vertex<>(1, "Vertex1");
        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex1, vertex1);
        otherEdge.setWeight(21.22);
        assertEquals(21.22, otherEdge.getWeight(),Double.MIN_VALUE);
    }
    ...
    public void TestGetVOrig() {
        ...
        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex1, vertex2);
        assertEquals(vertex1.getElement(),otherEdge.getVOrig());
    }
    ...
    public void TestSetVOrig() {
        Vertex<String, String> vertex1 = new Vertex<>(1, "Vertex1");
        Vertex<String, String> vertex2 = new Vertex<>(2, "Vertex2");
        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex2, vertex2);
    ...
    public void TestGetVDest() {
        ...
        Vertex<String, String> vertex2 = new Vertex<>(2, "Vertex2");
        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex1, vertex2);
        assertEquals(vertex2.getElement(),otherEdge.getVDest());
    }
    ...
    public void TestGetEndpoints() {
        ...
        Vertex<String, String> vertex2 = new Vertex<>(2, "Vertex2");
        Edge<String, String> otherEdge = new Edge<>("edge1", 1.0, vertex1, vertex2);
        assertTrue(otherEdge.getEndpoints().length==2);
        assertEquals("Vertex1",otherEdge.getEndpoints()[0]);
        assertEquals("Vertex2",otherEdge.getEndpoints()[1]);
